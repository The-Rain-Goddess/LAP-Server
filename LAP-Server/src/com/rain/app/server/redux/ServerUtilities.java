...
public class ServerUtilities {
	...
	public static String mapOfListsToString(Map<Integer, ArrayList<AggregatedChampionData>> rankedChampionDataMap){
		String r = "";
		for(Entry<Integer, ArrayList<AggregatedChampionData>> entry : rankedChampionDataMap.entrySet()){
			r = r + entry.getKey() + ":\n";
